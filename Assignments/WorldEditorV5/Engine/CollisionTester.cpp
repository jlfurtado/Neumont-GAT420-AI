...
namespace Engine
{
	...
	void CollisionTester::SetGridScale(float newScale)
	{
		for (CollisionLayer c = CollisionLayer::STATIC_GEOMETRY; c != CollisionLayer::NUM_LAYERS; c = (CollisionLayer)((unsigned)c + 1))
		{
